...
ls -rt : 파일들 생성 시간순(제일 오래된 것 부터) 으로 표시
...
7     111 rwx 모든 권한 있음
예를 들어 '777'의 경우 이진수로 1111111111이고
rwxrwxrwx라는 의미를 가지므로 파일 소유자,
소유 그룹 일반 사용자에게 읽기,쓰기,실행의 모든
권한을 주는 설정이다.
